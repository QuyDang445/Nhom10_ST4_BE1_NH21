                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="inputStatus" class="form-control custom-select" name="manu" >
                                    ...
                                    <?php
                                    $getAllManu = $manufacture->getAllManus();
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputClientCompany" class="form-control" name="price" ?="<?php echo $values['price'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="inputProjectLeader">Image</label>
                                <input type="file" name="image" id="image" class="form-control" value="<?php echo $values['pro_image'] ?>"?>
                                <img style="width:100px;height:100px" src="../img/<?php echo $values['pro_image'] ?>" alt="">
                            </div>
                            <div class="form-group">
