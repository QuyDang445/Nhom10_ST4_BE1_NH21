...
<div class="content-wrapper">
  ...
  <section class="content">
    <form action="editptype.php?id=<?php echo $values['type_id'] ?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="name" value="<?php echo $values['type_name'] ?>" class="form-control" name="name">
              </div>
            </div>
